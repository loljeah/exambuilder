...
export function GetDomainAchievements(arg1) {
  return window['go']['main']['App']['GetDomainAchievements'](arg1);
}
...
export function ScanAndImportExams(arg1) {
  return window['go']['main']['App']['ScanAndImportExams'](arg1);
}
